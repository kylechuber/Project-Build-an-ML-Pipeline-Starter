...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact",
        type=str,
        help="The name of the input artifact to clean (the raw sample data from W&B)",
        required=True
    )
    parser.add_argument(
        "--output_artifact",
        type=str,
        help="The name for the output artifact that will hold the cleaned data",
        required=True
    )
    parser.add_argument(
        "--output_type",
        type=str,
        help="The type to assign to the output artifact",
        required=True
    )
    parser.add_argument(
        "--output_description",
    ...
    parser.add_argument(
        "--min_price",
        type=float,
        help="The minimum price to keep; rows below this are dropped as outliers",
        required=True
    )
    parser.add_argument(
        "--max_price",
        type=float,
        help="The maximum price to keep; rows above this are dropped as outliers",
        required=True
    )
